all: 
	gcc main.c bolha.c selecao.c insercao.c mergesort.c shellsort.c quicksort.c heapsort.c countingsort.c  geracao.c
 
# exec: geracao.o bolha.o countingsort.o heapsort.o insercao.o mergesort.o quicksort.o selecao.o shellsort.o
# 	gcc -o exec geracao.o bolha.o countingsort.o heapsort.o insercao.o mergesort.o quicksort.o selecao.o shellsort.o
